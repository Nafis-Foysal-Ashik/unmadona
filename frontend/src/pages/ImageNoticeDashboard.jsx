...
const ImageNoticeDashboard = () => {
  ...
  const handleUpload = async (e) => {
    try {
      ...
      await axios.post(
        "https://unmadona-api.onrender.com/api/homepage-images/upload",
        formData,
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(
        `https://unmadona-api.onrender.com/api/homepage-images/delete/${id}`
      );
  ...
  const handleSaveNotice = async () => {
    try {
      await axios.post(
        "https://unmadona-api.onrender.com/api/notice/save",
        { noticeText }
      );
