...
const EditStudentProfile = () => {
  ...
  const fetchStudents = async () => {
    try {
      const res = await axios.get("https://unmadona-api.onrender.com/api/students/all");
          ...
          <div className="mt-3 flex space-x-2">
            <button
              onClick={async () => {
                try {
                  await axios.delete(
                    `https://unmadona-api.onrender.com/api/students/delete/${id}`
                  );
              ...
              {currentStudents.map((student) => (
                <tr key={student._id} className="text-center">
                  ...
                  <td className="border p-2">
                    <img
                      src={`https://unmadona-api.onrender.com${student.image}`}
                      alt={student.name}
